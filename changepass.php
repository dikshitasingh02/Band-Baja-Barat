			...
			<div class="col-sm-8 row_1">
			    <?php
					if(isset($_GET["empty"])){
						...
						echo "<h3 style='color:red'>New Password and Retype Password not same</h3>";
					}
				...
				<table class="table_working_hours">
		        	<tbody>
					    ...
					    <tr class="closed">
						    <td class="day_label" colspan=2><br><input type="submit" value="Submit" class="btn btn-dander" style="float:right"></td>
							</tr>
				    </tbody>
				</table>
				</form>
